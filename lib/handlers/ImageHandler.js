    ...
    constructor(handler) {
        ...
        this.createFilters = (filters) => {
            return filters.reduce((prev, filter) => {
                ...
                if (type.toLowerCase() === 'convolute' && lodash_1.isEqual(filter.matrix, SHARPEN_MATRIX)) {
                    type = 'sharpen';
                }
                else if (type.toLowerCase() === 'convolute' && lodash_1.isEqual(filter.matrix, EMBOSS_MATRIX)) {
                    type = 'emboss';
                }
